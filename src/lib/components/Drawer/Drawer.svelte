<script lang="ts">
	...
	const condensedWrapperClass =
		'p-4 bg-white rounded-md shadow-[0px_4px_6px_0px_rgba(0,0,0,0.09)] outline outline-1 outline-slate-100 flex flex-col justify-start items-start gap-4';
</script>

{#if drawer.isOpen}
	<aside
		class={cn('drawer fixed top-28 right-10 h-[87svh] w-lg', condensedWrapperClass)}
